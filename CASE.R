...
write.csv(CASERainMatrixORG,file = "resultCASE/rainCASEORG_Site25.csv")
...
write.csv(CASERainMatrixOPT,file = "resultCASE/rainCASEOPT_Site10.csv")
...
write.csv(CASEFlowMatrixORG,file = "resultCASE/flowCASEORG_Site25.csv")
